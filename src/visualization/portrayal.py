...
model_kwargs = {"initial_people": mesa.visualization.Slider(name="Quantidade de pessoas", min_value=0, max_value=10, step=1, value=1),
                "initial_mosquitoes": mesa.visualization.Slider(name="Quantidade de insetos", min_value=0, max_value=10, step=1, value=1),
